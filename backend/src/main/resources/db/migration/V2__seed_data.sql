...
('Orange', 3, 'Orange description', 'Orange full description', 5.00, 'PLN', NULL, 'orange'),
('Banana', 3, 'Banana description', 'Banana full description', 4.40, 'PLN', NULL, 'banana'),
('Potato', 4, 'Potato description', 'Potato full description', 1.20, 'PLN', NULL, 'potato'),
('Tomato', 4, 'Tomato description', 'Tomato full description', 7.00, 'PLN', NULL, 'tomato'),
('Onion', 4, 'Onion description', 'Onion full description', 1.70, 'PLN', NULL, 'onion'),
('Milk', 2, 'Milk description', 'Milk full description', 2.70, 'PLN', NULL, 'milk'),
('Cheese', 2, 'Cheese description', 'Cheese full description', 20.50, 'PLN', NULL, 'cheese'),
('Butter', 2, 'Butter description', 'Butter full description', 7.00, 'PLN', NULL, 'butter'),
('Pork', 5, 'Pork description', 'Pork full description', 16.00, 'PLN', NULL, 'pork'),
('Steak', 5, 'Steak description', 'Steak full description', 50.00, 'PLN', NULL, 'steak'),
('Bread', 1, 'Bread description', 'Bread full description', 5.00, 'PLN', NULL, 'bread'),
('Cereals', 1, 'Cereals description', 'Cereals full description', 8.00, 'PLN', NULL, 'cereals'),
...
-- Hasło seedowego admina: admin123 (dev only — zmień po pierwszym logowaniu).
INSERT INTO users (id, username, password, enabled)
VALUES (1, 'admin@dudios.pl', '{bcrypt}$2y$10$8b7qTsrFokZXJ9XUAVy8de1kvO7P7XbLIZTE1Wme.wFWsBglraD4i', true);
INSERT INTO authorities (username, authority)
VALUES ('admin@dudios.pl', 'ROLE_ADMIN');
